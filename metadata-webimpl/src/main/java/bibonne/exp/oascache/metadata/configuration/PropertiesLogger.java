...
public class PropertiesLogger implements ApplicationListener<ApplicationEnvironmentPreparedEvent> {
    ...
    private static final Set<String> prefixesAffichesParDefaut= Set.of("bibonne/exp/oascache/metadata","logging","keycloak","spring","application","server","springdoc","management");
